...
function control(e) {
    ...
    if(e.keyCode === 39){
        direction = 1 //snake will go right one
    }else if(e.keyCode === 38){
        direction = -width //snake will go back 10 divs, appearing to go up
    }else if(e.keyCode === 37){
        direction = -1 //snake will go left one div
    }else if(e.keyCode === 40){
        direction = +width //snake head will instantly appear 10 divs from where we are now
    }
 }
